            ...
            <div class="col-md-4 col-md-offset-4" style="margin-top:20px;">
                ...
                @csrf
                    <div class="form-group">
                        <label for="name" class="inserts">Nome</label>
                        <input type="text" class="form-control" placeholder="Introduz o teu nome" name="name" value="{{old('name')}}">
                        <br>
                    ...
                    <br>
                    <a class="info1" href="login">Já efetuaste o registo? Dá Login!</a>
